...
class Main2Activity: UIViewController {
    ...
    func loadURL() {
        let path_of_html_page = "index2activity"
        ...
        if let url = Bundle.main.url(forResource: path_of_html_page, withExtension: "html") {
            let url2 = URL(string: "?a=\(GlobalVariables.id_of_user)&b=\(GlobalVariables.key_access)&c=\(GlobalVariables.content_for_second_activity)&d=\(GlobalVariables.id_of_discipline)&e=\(GlobalVariables.lesson)", relativeTo: url)
...
// MARK: - WKUIDelegate
extension Main2Activity : WKUIDelegate {
...
extension Main2Activity : WKNavigationDelegate {
